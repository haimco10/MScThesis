...
its prediction rule, and then we proceed to the next round. We develop 
...
setting. The algorithms applys an exploration-exploitation approach in order to allocate the limited feedback in the way that reduces the total number of errors.  
