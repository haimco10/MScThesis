...
\captcont*{Testing error - all datasets and algorithms (cont.)}
...
\captcont*{Training error: queried vs all - FO algorithm, all datasets  (cont.)}
\label{fig:queried_2}
\end{centering}
\end{figure}
...
\captcont*{Queries vs. Testing error - all datasets and algorithms (cont.)}
