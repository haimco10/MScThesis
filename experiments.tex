...
There are algorithms and datasets (e.g. VJ one-vs-one in \figref{fig:train_err_v1}), that this point converges
...
\subsection{How to choose the tradeoff parameter}
