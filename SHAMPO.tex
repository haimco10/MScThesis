...
only the label of the task $J_t$ is used in practice, as for other tasks $Z_{i,t}=0$.
...
\begin{proof}
Here we extend the proof of   ~\thmref{bound_aggressive_FO_SHAMPO}, while now, 
...
\end{theorem} \label{thm:adaptive_bound}
 ...
 \noindent
 \begin{proof}
The proof here is an extended version of the proof in \thmref{thm:FO_theorem}. As in 
